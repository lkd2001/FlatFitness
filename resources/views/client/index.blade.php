            ...
            <ul class="sequence-canvas">
                <li class="animate-in">
                    ...
                    <div class="flat-caption caption3 formLeft delay500 text-center">
                        <p>Chào mừng đến với cửa hàng dụng cụ thể dục của chúng tôi - nơi cung cấp các sản phẩm đa dạng và chất lượng cao</p>
                        <p>Tập thể hình của bạn là niềm đam mê - Hãy để chúng tôi giúp bạn thể hiện nó</p>
                    </div>
                    <div class="flat-image formBottom delay200" data-duration="5" data-bottom="true"><img src="{{ asset('asset/client/images/banner1.png') }}" alt=""></div>
                </li>
                <li>
                    <div class="flat-caption caption2 formLeft delay400 text-center">
                        <h1>FITNESS STORE</h1>
                    ...
                    <div class="flat-image formBottom delay200" data-bottom="true"><img src="{{ asset('asset/client/images/banner2.png') }}" alt=""></div>
                </li>
            </ul>
        </div>
    </div>
